...
const mapStateToProps = ({ langs, text, dropdown, fromBar, fromActive, toBar, toActive }) => {
    return ({ langs, text, dropdown, fromBar, fromActive, toBar, toActive })
}
